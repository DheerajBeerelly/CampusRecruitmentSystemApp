...
public class CompanySelectedApplication extends AppCompatActivity {
    ...
    String userName,id,selectedJob,studentNamepath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_selected_application);
        ...
        studentNamepath = i.getStringExtra("studentName");
        //Toast.makeText(StudentSelectedApplication.this,companyName,Toast.LENGTH_LONG).show();

        jobRef = database.getReference("companies/"+ userName+"/job/"+selectedJob);
        ...
        jobRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Toast.makeText(CompanySelectedApplication.this,"error loading",Toast.LENGTH_LONG );
                }
            }
        ...
        personalref= database.getReference("students/" + studentNamepath+"/profile");
        ...
        personalref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Toast.makeText(CompanySelectedApplication.this,e.toString(),Toast.LENGTH_LONG ).show();
                }
            }
        ...
        sscRef = database.getReference("students/" + studentNamepath+"/profile/academicDetails/ssc");
        ...
        sscRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Toast.makeText(CompanySelectedApplication.this,"Student Not\nupdated Academic \ndetails",Toast.LENGTH_LONG ).show();
                }
            }
        ...
        higherRef = database.getReference("students/" + studentNamepath+"/profile/academicDetails/higher");
        ...
        gradRef = database.getReference("students/" + studentNamepath+"/profile/academicDetails/graduation");
