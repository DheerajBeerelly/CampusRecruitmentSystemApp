...
public class CompanyLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference myRef = database.getReference("companyLogin");
            ...
            public void onClick(View view) {
                ...
                try {
                    if (value.child(username).getValue().toString().equals(pass)) {
                        ...
                        Toast.makeText(CompanyLogin.this, "enter correct credentials", Toast.LENGTH_LONG).show();
                    }
                }
                catch (Exception e){
    ...
    public void openSignUp(){
        Intent i = new Intent(this,CompanySignUp.class );
        startActivity(i);
    }
