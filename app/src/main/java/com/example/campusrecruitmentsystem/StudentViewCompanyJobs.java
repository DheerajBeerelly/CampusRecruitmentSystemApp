...
public class StudentViewCompanyJobs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_view_companyjobs);
        ...
        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(StudentViewCompanyJobs.this, android.R.layout.simple_list_item_1,job);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(view.getContext(),StudentSelectedJobDetails.class);
        ...
        compRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Toast.makeText(StudentViewCompanyJobs.this,"error loading",Toast.LENGTH_LONG );
                }
            }
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Toast.makeText(StudentViewCompanyJobs.this,"error loading",Toast.LENGTH_LONG ).show();
                }
            }
